...
train_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load('/ubuntu/CS643-AWS-ProgAssgn-2/TrainingDataset.csv')
test_df = spark.read.format('csv').options(header='true', inferSchema='true', sep=';').load('/ubuntu/CS643-AWS-ProgAssgn-2/ValidationDataset.csv')
